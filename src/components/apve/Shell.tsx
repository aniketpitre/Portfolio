...
export default function Shell() {
  const { history, pushToHistory, toggleShell, isShellOpen, ...context } = useAppContext();
  ...
  const handleCommand = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const result = processCommand(input, { history, pushToHistory, toggleShell, isShellOpen, ...context });

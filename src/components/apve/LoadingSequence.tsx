...
const sequence = [
  { text: 'Connecting to aniketpitre.com (192.168.1.1)...', delay: 100 },
  { text: 'Connection established.', delay: 150 },
  { text: 'Requesting guest-level access...', delay: 120 },
  { text: 'Authenticating...', delay: 200 },
  { text: 'ACCESS GRANTED.', delay: 100, className: 'text-green-500 flex items-center justify-center gap-2' },
  { text: 'Loading virtual environment...', delay: 150 },
  { text: 'Welcome.', delay: 100, className: 'text-primary' },
];
    ...
    sequence.forEach((item, index) => {
      const timeout = setTimeout(() => {
        ...
        if (index === sequence.length - 1) {
          setShowCursor(false);
          const finishTimeout = setTimeout(onFinished, 250);

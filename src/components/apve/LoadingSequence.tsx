...
const sequence = [
  { text: 'Connecting to aniketpitre.com (192.168.1.1)...', delay: 250 },
  { text: 'Connection established.', delay: 350 },
  { text: 'Requesting guest-level access...', delay: 300 },
  { text: 'Authenticating...', delay: 400 },
  { text: 'ACCESS GRANTED.', delay: 150, className: 'text-green-500 flex items-center justify-center gap-2' },
  { text: 'Loading virtual environment...', delay: 350 },
  { text: 'Welcome.', delay: 250, className: 'text-primary' },
];
    ...
    sequence.forEach((item, index) => {
      const timeout = setTimeout(() => {
        ...
        if (index === sequence.length - 1) {
          setShowCursor(false);
          const finishTimeout = setTimeout(onFinished, 500);
